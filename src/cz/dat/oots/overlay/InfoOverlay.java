...
public class InfoOverlay implements IOverlayRenderer {
	...
	public void renderOverlay(float partialTickTime) {
		...
		font.drawString(Settings.getInstance().windowWidth.getValue()
				- stringWidth - 2, font.getHeight() * 2, fpsString);
		...
		font.drawString(
				Settings.getInstance().windowWidth.getValue()
						- font.getWidth(chunks) - 2, font.getHeight(), chunks);

		if(world.getChunkProvider().loading) {
			font.drawString(
					Settings.getInstance().windowWidth.getValue()
							- font.getWidth("Loading chunks...") - 2,
					Settings.getInstance().windowHeight.getValue()
							- font.getHeight(), "Loading chunks...",
					Color.white);
		}
		...
		if(world.getRenderEngine().building) {
			font.drawString(
					Settings.getInstance().windowWidth.getValue()
							- font.getWidth("Building chunks...") - 2,
					Settings.getInstance().windowHeight.getValue()
							- font.getHeight()
		...
		GLHelper.drawLine(
				...
				Settings.getInstance().windowHeight.getValue() / 2, 2, 0, 0, 0,
				0.5f);
