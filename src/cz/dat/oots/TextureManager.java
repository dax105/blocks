...
public class TextureManager {
	...
	public static void load(Game game) {
		...
		TextureManager.logo = TextureManager
				.loadTex("cz/dat/oots/res/textures/logo.png");
		TextureManager.menuBg = TextureManager
				.loadTex("cz/dat/oots/res/textures/menubg.png");
		TextureManager.clouds = TextureManager
				.loadTex("cz/dat/oots/res/textures/clouds.png");

		TextureManager.skybox_back = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_back.png");
		TextureManager.skybox_bottom = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_bottom.png");
		TextureManager.skybox_front = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_front.png");
		TextureManager.skybox_left = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_left.png");
		TextureManager.skybox_right = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_right.png");
		TextureManager.skybox_top = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_top.png");
		TextureManager.skybox_side = TextureManager
				.loadTex("cz/dat/oots/res/textures/skybox_side.png");

		TextureManager.life_full = TextureManager
				.loadTex("cz/dat/oots/res/textures/life_full.png");
		TextureManager.life_zero = TextureManager
				.loadTex("cz/dat/oots/res/textures/life_null.png");
		TextureManager.imaginary_chocolate = TextureManager
				.loadTex("cz/dat/oots/res/textures/items/im_choc.png");
