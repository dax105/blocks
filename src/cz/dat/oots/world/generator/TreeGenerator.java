...
public class TreeGenerator {
    ...
    public void generateTree(int x, int y, int z) {
        ...
        this.fill(x - 2, y + leavesStart, z - 2, x + 2, y + leavesEnd - 2,
                z + 2, leaves);
        this.fill(x - 2, y + leavesStart + 2, z - 1, x + 2, y + leavesEnd - 1,
                z + 1, leaves);
        this.fill(x - 1, y + leavesStart + 2, z - 2, x + 1, y + leavesEnd - 1,
                z + 2, leaves);
