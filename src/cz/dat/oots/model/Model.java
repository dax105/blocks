...
public class Model {
                ...
                for (int z = 0; z < this.voxels[0][0].length; z++) {
                    ...
                    if (v != null) {
                        ...
                        if (this.isVoxelNull(x, y + 1, z)) {
                            ...
                            this.addVertexWithAO(x + 1f, y + 1f, z + 0f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x + 1, y + 1, z),
                                    this.isVoxelNull(x, y + 1, z - 1),
                                    this.isVoxelNull(x + 1, y + 1, z - 1)); // OK
                            this.addVertexWithAO(x + 0f, y + 1f, z + 0f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x - 1, y + 1, z),
                                    this.isVoxelNull(x, y + 1, z - 1),
                                    this.isVoxelNull(x - 1, y + 1, z - 1)); // OK
                            this.addVertexWithAO(x + 0f, y + 1f, z + 1f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x - 1, y + 1, z),
                                    this.isVoxelNull(x, y + 1, z + 1),
                                    this.isVoxelNull(x - 1, y + 1, z + 1)); // OK
                            this.addVertexWithAO(x + 1f, y + 1f, z + 1f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x + 1, y + 1, z),
                                    this.isVoxelNull(x, y + 1, z + 1),
                                    this.isVoxelNull(x + 1, y + 1, z + 1)); // OK
                        ...
                        if (this.isVoxelNull(x, y - 1, z)) {
                            GL11.glNormal3f(0, -1.0f, 0);
                            this.addVertexWithAO(x + 1f, y + 0f, z + 1f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x + 1, y - 1, z),
                                    this.isVoxelNull(x, y - 1, z + 1),
                                    this.isVoxelNull(x + 1, y - 1, z + 1)); // OK
                            this.addVertexWithAO(x + 0f, y + 0f, z + 1f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x - 1, y - 1, z),
                                    this.isVoxelNull(x, y - 1, z + 1),
                                    this.isVoxelNull(x - 1, y - 1, z + 1)); // OK
                            this.addVertexWithAO(x + 0f, y + 0f, z + 0f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x - 1, y - 1, z),
                                    this.isVoxelNull(x, y - 1, z - 1),
                                    this.isVoxelNull(x - 1, y - 1, z - 1)); // OK
                            this.addVertexWithAO(x + 1f, y + 0f, z + 0f,
                                    v.getR(), v.getG(), v.getB(),
                                    this.isVoxelNull(x + 1, y - 1, z),
                                    this.isVoxelNull(x, y - 1, z - 1),
                                    this.isVoxelNull(x + 1, y - 1, z - 1)); // OK
    ...
    private void addVertexWithAO(float x, float y, float z, float r, float g,
                                 float b, boolean s1, boolean s2, boolean c) {
        int ao;
