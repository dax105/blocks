...
public class Particle implements ITickListener, IWorldRenderer {
	...
	public Particle(World world, float x, float y, float z, float velX,
		...
		this.dead = false;
		this.ground = false;
		this.aabb = new AABB(this.x - Particle.PARTICLE_SIZE * 0.5f, this.y
				- Particle.PARTICLE_SIZE * 0.5f, this.z
				- Particle.PARTICLE_SIZE * 0.5f, this.x
				+ Particle.PARTICLE_SIZE * 0.5f, this.y
				+ Particle.PARTICLE_SIZE * 0.5f, this.z
				+ Particle.PARTICLE_SIZE * 0.5f);
		this.r = r;
		this.g = g;
		this.b = b;
	}
