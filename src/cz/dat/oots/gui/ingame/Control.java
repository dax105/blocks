...
public abstract class Control implements ITickListener {
    ...
    public Control(int relativeX, int relativeY, int width, int height,
                   GuiScreen screen) {
        this.relativeX = relativeX;
        this.relativeY = relativeY;
        this.screen = screen;
        this.rectangle = new Rectangle(relativeX + screen.getX(), relativeY
                + screen.getY(), width, height);
    }

    public void setPosition(int relativeX, int relativeY) {
        this.rectangle.set(relativeX + screen.getX(),
                relativeY + screen.getY(), this.rectangle.getWidth(),
