...
public class Rectangle {
	...
	public boolean intersects(Rectangle other) {
		return !(
				this.getX() > other.getTopRight() ||
				other.getX() > this.getTopRight() ||
				this.getY() > other.getBottomLeft() ||
				other.getY() > this.getBottomLeft()
				);
	}
	...
	public boolean equals(Object ob) {
		if(ob instanceof Rectangle) {
			...
			return (r.getPosition().equals(this.getPosition()) && r.getWidth() == this.getWidth() && 
					r.getHeight() == this.getHeight());
		}
