...
public class TextControl extends Control {
	...
	public TextControl(int relativeX, int relativeY, Font font, String text, GuiScreen screen) {
		super(relativeX, relativeY, font.getWidth(text), font.getHeight(text), screen);
	...
	public void render() {
		...
		this.font.drawString(this.rectangle.getX(), this.rectangle.getY(), this.text, this.color);
