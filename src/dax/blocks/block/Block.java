...
public abstract class Block extends Item {
	...
	public static final Block grass = new BlockBasic(3).setTopTexture(4).setSideTexture(5)
		.setBottomTexture(3).setStepSound(SoundManager.footstep_grass).setFallSound("fall_soft");
	public static final Block dirt = new BlockBasic(4).setAllTextures(3)
		.setStepSound(SoundManager.footstep_dirt).setFallSound("fall_soft");
	public static final Block stone = new BlockStone();
	public static final Block wood = new BlockBasic(6).setAllTextures(2)
		.setStepSound(SoundManager.footstep_wood).setFallSound("fall_hard");
	public static final Block stoneMossy = new BlockBasic(7).setAllTextures(1)
		.setStepSound(SoundManager.footstep_stone).setFallSound("fall_hard");
	public static final Block bricks = new BlockBasic(8).setAllTextures(8)
		.setStepSound(SoundManager.footstep_stone).setFallSound("fall_hard");
	public static final Block sand = new BlockSand();
	public static final Block log = new BlockBasic(10).setAllTextures(11).setSideTexture(7)
		.setStepSound(SoundManager.footstep_wood).setFallSound("fall_hard");
	public static final Block glass = new BlockBasic(11).setAllTextures(9).setOpaque(false)
		.setCullSame(true).setStepSound(SoundManager.footstep_stone).setFallSound("fall_hard")
	...
	public static final Block bedrock = new BlockBasic(13).setAllTextures(12)
		.setStepSound(SoundManager.footstep_stone).setFallSound("fall_hard");
	public static final Block water = new BlockFluid(14).setAllTextures(13)
		.setCullSame(true).setOccluder(false).setOpaque(false).setDensity(1.175f);
	public static final Block ice = new BlockBasic(15).setAllTextures(14)
		.setOpaque(false).setCullSame(true).setRenderPass(RenderPass.TRANSLUCENT);
